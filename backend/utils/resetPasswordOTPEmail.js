const generateResetPasswordOTPEmail = (otp, email) => `
<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <title>ExpenseTracker Password Reset</title>
</head>
  ...
  <table align="center" width="100%" cellpadding="0" cellspacing="0" style="max-width: 600px; margin: 40px auto; background-color: #ffffff; border: 1px solid #e5e7eb; border-radius: 12px;">
    <tr>
      <td style="background: linear-gradient(to right, #16a34a, #4f46e5); padding: 20px; text-align: center;">
        ...
        <p style="color: #e5e7eb; font-size: 14px; margin: 8px 0 0;">Password Reset Request ${email}</p>
      </td>
    </tr>
    <tr>
      <td style="padding: 24px;">
        <h2 style="font-size: 22px; font-weight: bold; color: #1f2937; margin: 0 0 16px;">Hello,</h2>
        <p style="font-size: 16px; color: #4b5563; line-height: 24px; margin: 0 0 16px;">
          We received a request to reset your ExpenseTracker account password. Please use the following One-Time Password (OTP) to proceed.
        </p>
        ...
        <p style="font-size: 16px; color: #4b5563; line-height: 24px; margin: 0 0 16px;">
          This OTP expires in 15 minutes. Please enter it on the password reset page to continue.
        </p>
...
module.exports = generateResetPasswordOTPEmail;
